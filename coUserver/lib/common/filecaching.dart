...
class FileCache {
	...
	static Future loadCaches() async {
		...
		heightsCache = new Map<String, int>.from(await loadCacheFromDisk('heightsCache.json'));
		headsCache = new Map<String, String>.from(await loadCacheFromDisk('headsCache.json'));
