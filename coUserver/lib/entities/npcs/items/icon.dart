...
class Icon extends EntityItem with MetabolicsChange {
	static final Map<String, Spritesheet> SPRITESHEETS = {
		'Alph': new Spritesheet('Alph',
			'files/sprites/generated/converted/icon-alph.png',
			95, 115, 95, 115, 1, true),
		'Cosma': new Spritesheet('Cosma',
			'files/sprites/generated/converted/icon-cosma.png',
			110, 105, 110, 105, 1, true),
		'Friendly': new Spritesheet('Friendly',
			'files/sprites/generated/converted/icon-friendly.png',
			90, 99, 90, 99, 1, true),
		'Grendaline': new Spritesheet('Grendaline',
			'files/sprites/generated/converted/icon-grendaline.png',
			86, 107, 86, 107, 1, true),
		'Humbaba': new Spritesheet('Humbaba',
			'files/sprites/generated/converted/icon-humbaba.png',
			81, 105, 81, 105, 1, true),
		'Lem': new Spritesheet('Lem',
			'files/sprites/generated/converted/icon-lem.png',
			94, 104, 94, 104, 1, true),
		'Mab': new Spritesheet('Mab',
			'files/sprites/generated/converted/icon-mab.png',
			84, 107, 84, 107, 1, true),
		'Pot': new Spritesheet('Pot',
			'files/sprites/generated/converted/icon-pot.png',
			111, 100, 111, 100, 1, true),
		'Spriggan': new Spritesheet('Spriggan',
			'files/sprites/generated/converted/icon-spriggan.png',
			74, 105, 74, 105, 1, true),
		'Tii': new Spritesheet('Tii',
			'files/sprites/generated/converted/icon-tii.png',
			91, 86, 91, 86, 1, true),
		'Zille': new Spritesheet('Zille',
			'files/sprites/generated/converted/icon-zille.png',
			104, 102, 104, 102, 1, true),
	};
