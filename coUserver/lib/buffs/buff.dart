...
class Buff {
	...
	bool get indefinite => length.inSeconds == -1; // buffs with a length of -1 will stay until removed
	...
	Future<PlayerBuff> getForPlayer(String email) async {
		...
		try {
			...
			int remaining = jsonDecode(rows.first.buffsJson)[id] ?? length.inSeconds;
