...
class AudioChannel
{
  ...
  /// Browsers create audio contexts in a suspended state until the first user
  /// interaction.  Expose the standard resume operation to clients so they
  /// can unlock an already-created channel from that gesture.
  Future resume()
  {
