...
dynamic decodeJson(String json, Type type) {
  return jsonCodec.decode(jsonDecode(json), type);
}
...
String encodeJson(dynamic input) {
  return jsonEncode(jsonCodec.encode(input));
}
...
typedef dynamic MapperEncoder(Object obj, FieldEncoder fieldEncoder, 
