...
| active | Continue asset conversion | Only 4 of ~5400 `glitch-items` files are converted so far. Next candidates: fox, butterfly, salmon, helikitty, and the bean/bubble/fruit/paper trees (more complex procedural frame scheme than wood_tree/rock_metal). |
